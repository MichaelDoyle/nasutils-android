...
public class BackupJobResource {
    ...
    @Element(name="Ejectable", required=false)
    private int mEjectable;

    @Element(name="Eject", required=false)
    private int mEject;
    ...
    public int getEjectable() {
        return mEjectable;
    }

    public void setEjectable(int ejectable) {
